...
<script setup lang="ts">
    ...
    const submitFormPaf = async () => {
      try {
        const res = await axios.post('http://localhost:8000/api/boxpaf/', boxPaf)
    ...
    const fetchPaf = async () => {
      try {
        const respaf = await axios.get('http://localhost:8000/api/boxpaf/')
    ...
    const submitEditPaf = async () => {
      ...
      try {
        await axios.patch(`http://localhost:8000/api/boxpaf/${selectedPafId.value}/`, editDataPaf)
    ...
    const submitDeletePaf = async () => {
      ...
      try {
        await axios.delete(`http://localhost:8000/api/boxpaf/${selectedPaf.value.id}/`)
    ...
    const submitFormOp = async () => {
      try {
        const res = await axios.post('http://localhost:8000/api/boxop/', boxOp )
        boxOp.numero_boxOp = ''
        await fetchOp()
        alert.showAlertNotif(
            "Enregistrement effectué avec succès",
    ...
    const fetchOp = async () => {
      try {
        const resop = await axios.get('http://localhost:8000/api/boxop/')
    ...
    const submitEditOp = async () => {
      ...
      try {
        await axios.patch(`http://localhost:8000/api/boxop/${selectedOpId.value}/`, editDataOp)
    ...
    const submitDeleteOp = async () => {
      ...
      try {
        await axios.delete(`http://localhost:8000/api/boxop/${selectedOp.value.id}/`)
