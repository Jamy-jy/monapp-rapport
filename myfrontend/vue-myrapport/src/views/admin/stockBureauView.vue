...
<script setup lang="ts">
    ...
    watch(() => formData.consommable, async (newId) => {
        ...
        try {
            const res = await axios.get(`${API_CONFIG.LOCAL.BASE_URL}/stock-bureau/`, {
    ...
    const submitStock = async () => {
        ...
        try {
            const res = await axios.post(`${API_CONFIG.LOCAL.BASE_URL}/stock-bureau/`, {
    ...
    const fetchAlertesStock = async () => {
        try {
            const res = await axios.get(`${API_CONFIG.LOCAL.BASE_URL}/stock-bureau/alertes/`)
