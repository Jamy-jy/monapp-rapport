  ...
  <div>
    <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 lg:mb-6">Addresse</h4>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Quartiers</p>
            ...
            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Domicile</p>
        ...
        >
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              toute modification apporté sera appliqué immediatement.
            </p>
          </div>
